  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-[64%] -translate-y-1/2 bg-[#F1EEE7] hover:bg-[#e5e1d5] active:scale-95 transition duration-200 text-[#566700] font-semibold text-lg px-12 py-4 rounded-full cursor-pointer tracking-wider"
      >
        Explorar
      </button>
    </div>
