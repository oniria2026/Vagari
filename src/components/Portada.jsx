...
export default function Portada({ onExplorar }) {
  return (
    ...
    >
      ...
      {/* Centro de la pantalla: vagari bien grande arriba del botón */}
      <motion.div
      ...
      >
        <h1 className="font-naiveer text-7xl sm:text-8xl md:text-9xl text-[#F1EEE7] tracking-wider drop-shadow-2xl whitespace-nowrap">
          vagari
        </h1>
      </motion.div>
